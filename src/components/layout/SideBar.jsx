...
const sidebarItems = [
      { label: 'Users', icon: 'user', key: 'users', path : "/" },
      { label: 'Profile', icon: 'lock', key: 'permissions', path : "/profile" },
      { label: 'Management', icon: 'user', key: 'beneficiary', path : "/management" },
      { label: 'Payment', icon: 'swap', key: 'transactions', path : "/payment" },
      { label: 'Support', icon: 'reverse', key: 'reverse', path : "/support" },
  ...
  return (
    ...
    >
      <Box sx={{ p: 3 }}>
        ...
        <Box sx={{mb:3}}>
          <img src="NTT Data Payment Services Logo.png" alt="" style={{width:'210px',height:'40px',
objectFit: 'contain',
      display: 'block'
...
// {section.section && (
//   <Typography variant="subtitle2" color="#A3AED0" fontWeight={600} sx={{ pl: 2, mb: 1 }}>
//     {/* {section.section} */}
//   </Typography>
// )}